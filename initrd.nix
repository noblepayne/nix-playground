...

{
  ...
  boot.initrd.postDeviceCommands = ''
    ...
    /tools/nix/bin/nix build --store /mnt-rot/nix/store  --no-write-lock-file github:noblepayne/nix-playground#nixosConfigurations.testsystem.config.system.build.toplevel -o /tmp/toplevel
  '';
}
